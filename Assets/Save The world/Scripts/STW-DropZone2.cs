...
//    [HideInInspector] public string fieldName; // Nouveau : pour identifier le champ

//    public void Initialize(TMP_Text textComponent, string name)
//    {
//        targetText = textComponent;
//        originalText = textComponent.text;
//        fieldName = name; // Sauvegarder le nom du champ
//    }
...
//        {
//            targetText.text = "?";
//            // Remettre la couleur rouge pour indiquer que c'est une zone de drop
