...
public class SW_ScoreDelivring : MonoBehaviour
{
    public void deliverScore(int lastScore)
    {
        ...
        if (FirebaseManager.Instance != null && FirebaseManager.Instance.IsFirebaseReady)
        {
            ...
            gameProgressRef.GetValueAsync().ContinueWithOnMainThread(task =>
            {
                ...
                {
                    PlayerGlobalData.Instance.SaveTheWorldScore = lastScore;

                    Debug.Log("the last score of choose answer game is stored correctly :" + PlayerGlobalData.Instance.SaveTheWorldScore);
                }
        ...
        if (GameConfigManager.Instance != null)
        {
            ...
            Debug.Log("the last score of choose answer game is stored correctly in the GameConfigSingletons :" + GameConfigManager.Instance.verticalOperationsScore);
        }
        else
        {
